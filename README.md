...
- [GPT-5.4 dropped. The hype isn't fully justified, but the shift is real](https://larsniet.com/journey/gpt54-ai-infrastructure-for-developers) — GPT-5.4 is out and everyone is losing their mind about it. I think the hype is a bit overblown, but the direction it signals for developers is genuinely worth paying attention to.
- [iCare: A free 20-20-20 eye-break reminder for iPhone and Apple Watch](https://larsniet.com/journey/icare) — A minimal eye-break reminder app that follows the 20-20-20 rule. Built with SwiftUI for iPhone and Apple Watch, with no accounts, no backend, and no subscription. Just quiet reminders and a 20-second countdown.
...
<!-- PROJECT-LIST:START -->
- [Introducing data visualization at Adhese: My internship journey](https://larsniet.com/journey/adhese-cubejs) — How I built a custom data visualization platform at Adhese during my internship, replacing Google Data Studio with a faster, more capable reporting environment built on Cube.js.
- [Building a TypeScript/JavaScript SDK for Adhese's advertising software](https://larsniet.com/journey/armp-sdk) — Developing a customized TypeScript/JavaScript SDK for Ahold with Adhese integration, offering seamless client-specific advertising solutions and enhanced performance.
- [Crafting connected ESP32 Hello Kitty lights: A DIY anniversary gift](https://larsniet.com/journey/crafting-hello-kitty-diy-connected-lights) — For our anniversary, I decided to blend technology with my girlfriends favourite characters to create a pair of connected Hello Kitty-themed lights. These aren't just any lights—they communicate! When one light turns off, the other follows suit, symbolizing connection (at least that was the idea). Plus, they can be controlled remotely via a web application.
...
- [Get Telegram notifications when any web page changes](https://larsniet.com/journey/wbw) — A Dockerized Python bot that monitors any web page for element changes and sends you a Telegram message the moment something updates. Supports both static HTML parsing and full JavaScript rendering for dynamic content.
